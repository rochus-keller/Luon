...
ffi.cdef[[
	...
	int PAL2_init(uint8_t* b, int len, int w, int h);
	int PAL2_deinit();
	...
	void PAL2_updateArea(int x,int y,int w,int h,int cx,int cy,int cw,int ch);
...
function Display_updateArea(x,y,w,h,cx,cy,cw,ch)
	C.PAL2_updateArea(x,y,w,h,cx,cy,cw,ch)
end
